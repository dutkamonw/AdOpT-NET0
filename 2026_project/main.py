...
# [IMPORTANT] This study has added 2025 PPI data into "producer_price_index_euro.csv" file, which the original file was generated by Step 1. So, if you run Step 1, make sure to update the "producer_price_index_euro.csv" file before running following steps.

# Change to 'True' if you need to (re)run OR 'False' to skip the step
intialize = False # Step 1) initialize the adopt-net0 template
